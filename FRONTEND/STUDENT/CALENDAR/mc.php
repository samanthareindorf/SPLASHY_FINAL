...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
   ...
   <title>Master Calendar Documents</title>
...
<!--sidebar-->
                <div id="sticky" class="d-flex flex-column vh-300 flex-shrink-0 p-3 text-white bg-danger" style="width: 260px;"> <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg class="bi me-2" width="40" height="42"> </svg> <span class="fs-4">SPLASHY</span> </a>
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                      ...
                      <!--Master Link-->
                        <li> <a href="mc.php" class="nav-link active"> <i class="fa fa-graduation-cap" style="font-size:23px"></i><span class="ms-2">Master Calendar</span> </a> </li>
...
<div id="container" style="margin-left: 400px; margin-top: -700px; width: 750px; ">
    <h1>Master Calendar Documents</h1>
    ...
    {$hide=".";
     ...
     // Opens directory
     $myDirectory=opendir("../../FACULTY/uploads");
    ...
    // Separates directories, and performs operations on those directories
        if(is_dir($dirArray[$index]))
        {
            ...
            // Cleans up . and .. directories
                if($name=="."){$name="../../FACULTY/uploads"; $extn="&lt;System Dir&gt;"; $favicon=" style='background-image:url($namehref/.favicon.ico);'";}
                if($name==".."){$name="../../FACULTY/uploads"; $extn="&lt;System Dir&gt;";}
        }
    ...
    // Output
     echo("
        <tr class='$class'>
            <td><a href='../../FACULTY/uploads/$namehref' $favicon class='name'>$name</a></td>
        </tr>");
       }
    }
    ?>
